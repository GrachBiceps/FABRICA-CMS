    ...
    <table class="w-full break-words divide-y-2 shadow-sm">
        ...
        <tr class="grid text-center grid-cols-12 p-2 " v-for="items in tbData" :key="items.id"> <!-- Отрисовка элементов таблицы -->
          ...
          <td class="grid grid-cols-3 col-span-2 gap-1 "> <!-- Кнопки -->
            <button class="p-2 w-full col-span-2 my-auto shadow-sm rounded-lg bg-green-400 text-white">Редактировать</button>
        ...
        <tr class="grid text-center grid-cols-12  " >
          <td class="my-auto">№</td>
          <td class="my-auto col-span-3 w-full h-4/5"><input class="text-center w-full h-full" placeholder="Название"></td>
          <td class="my-auto col-span-2 w-full h-4/5"><input class="text-center w-full h-full" placeholder="Колличество"></td>
          <td class="my-auto col-span-2 w-full h-4/5"><input class="text-center w-full h-full" placeholder="Цена"></td>
          <td class="my-auto col-span-2 w-full h-4/5"><input class="text-center w-full h-full" placeholder="Сумма"></td>
          <td class="flex grid-cols-3 col-span-2">
            <button class="w-full text-center col-span-3 m-2 p-2 mt-2 mb-2 shadow-sm rounded-lg my-auto bg-green-400 text-white" >Добавить</button>
          </td>
        </tr>
    </table>
  </div>
...
<script>
  export default {
    data() {
      return{
         tbData: [ // Массив строк
            { id: 1, name: 'афафыафыафыаasdasdaasdasdasdadsdadasdasdasdsa', count: 1, price: 1, amount: 1 },
            { id: 2, name: 'фыафафыаф', count: 2, price: 1, amount: 1 },
            { id: 3, name: 'афыафафы', count: 1, price: 1, amount: 1 }
        ]
      }
    }
  }
